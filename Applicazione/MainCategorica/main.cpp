...
int main(int argc, char** argv){
	...
	if(is_K_init){
	  if(K_init>Dim){
		cout<<"You can't have a number of cluster higher than the number of distinct words"<<endl;
    ...
    const std::string wd="setwd(\"~/APSC_Parisi_Perego/MainCategorica/R_results\")";		// imposta la wd per R, la passo ad ogni funzione che usa R
